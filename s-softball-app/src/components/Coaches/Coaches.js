...
let coaches = [
    {
        first_name: 'sue', last_name: 'Stricker', image: SuePortriat, color: 'red',
    ...
    {
        first_name: 'Megan', last_name: 'Stricker', image: MegPortrait, color: 'blue',
        description:
...
Email:   Megan_stricker@yahoo.com`
    ...
    {
        first_name: 'Jennah', last_name: 'Perryman', image: JenaPortrait, color: 'blue',
        description:
    ...
    {
        first_name: 'Jenny', last_name: '', image: JenyPortrait, color: 'red'
    },
    {
        first_name: 'ally', last_name: '', image: AllyPortrait, color: 'red'
    },
    {
        first_name: 'Dot', last_name: '', image: DotPortrait, color: 'blue'
    }
]
                            ...
                            <div className={`${coach.color === 'blue' ? 'coach-card card-2nd' : 'coach-card'}`}>
                                ...
                                <div className='img-div'>
                                    <div className='img-overflow'>
                                        <img src={coach.image} alt={coach.first_name} />
                                    </div>
                                </div>
