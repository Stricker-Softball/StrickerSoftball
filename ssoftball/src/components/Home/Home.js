...
function Home(props) {
    ...
    return (
        <div className="Home">
            ...
            <button onClick={() => externalLink('https://www.amazon.com/dp/B0DV5CXX1J?ref_=cm_sw_r_ffobk_cp_ud_dp_2Z12YR9M5JMDMPAABR44_1&skipTwisterOG=1&bestFormat=true&newOGT=1')} className="button-main"> Get a copy</button>
            </div>
